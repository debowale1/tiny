...
var createPost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, body, category, image) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alert.showAlert)();
            _context.next = 10;
            break;
...
var writeComment = /*#__PURE__*/function () {
  ...
  return function writeComment(_x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
