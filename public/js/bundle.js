...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert-".concat(type, "\" role=\"alert\">\n                    ").concat(msg, "\n                  </div>"); // document.querySelector('.form-signin').insertAdjacentHTML('afterbegin', markup)
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('danger', _context.t0.response.data.error);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Your Account was created successfully!');
              setTimeout(function () {
                window.location.assign('/');
              }, 1500);
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('danger', _context2.t0.response.data.error);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Data updated sucessfully!');
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('danger', _context.t0.response.data);
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"posts.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.writeComment = exports.createPost = void 0;
...
var createPost = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, body, category, tags, image) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alert.showAlert)('success', 'New Post Added Successfully!');
            _context.next = 10;
            break;
  ...
  return function createPost(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
...
var writeComment = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(comment, postId) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') (0, _alert.showAlert)('success', 'comment was successfully posted!');
            _context2.next = 10;
            break;
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alert.showAlert)('danger', _context2.t0.response.data);
  ...
  return function writeComment(_x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();

exports.writeComment = writeComment;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var currentPassword = document.querySelector('#passwordCurrent').value;
    var password = document.querySelector('#password').value;
    var passwordConfirm = document.querySelector('#passwordConfirm').value;
    console.log(currentPassword, password, passwordConfirm);
    (0, _updateSettings.updateUserPassword)(currentPassword, password, passwordConfirm);
  });
}
...
if (addPostForm) {
  addPostForm.addEventListener('submit', function (e) {
    ...
    (0, _posts.createPost)(title, body, category, tags, image);
  });
}
...
if (commentForm) {
  commentForm.addEventListener('submit', function (e) {
    ...
    (0, _posts.writeComment)(comment, postId);
